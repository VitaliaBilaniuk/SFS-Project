...
const sfsTabsStyle = "W(100p/3) P(20) Cur(p) Fz(14) C(#111123) Td(n) Bgc(#cccccc)-h Bgc(#cccccc)_active";
    ...
    <Router>
      <div>
        <div className="sfs-nav D(f) Bdbw(1) Bdbs(s) Bdbc(#111123)">
          <NavLink className={sfsTabsStyle} exact to ="/"><img src={MailLogo} className="Mend(10) H(10)"/>Email signature</NavLink>
          <NavLink className={sfsTabsStyle} to ="/tab2"><img src={PassCard} className="Mend(10) H(10)"/>Pass Card</NavLink>
          <NavLink className={sfsTabsStyle} to ="/tab3"><img src={BusinessCard} className="Mend(10) H(10)"/>Business card</NavLink>
        </div>
